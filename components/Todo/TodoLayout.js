...
export default function TodoLayout() {
  ...
  return (
    <div className='md:w-1/2 p-5 bg-4 text-white h-full w-full bg-gradient-to-br from-8 to-9'>
      <main className='flex flex-col m-auto w-full h-full'>
        ...
        <div className='overflow-y-scroll h-full p-6 bg-red-100 rounded-2xl relative'>
          ...
          {todos.map((todo) => (
            <TodoItems key={todo}>
              <div className='todo-text text-black font-semibold subpixel-antialiased' key={todo}>
                {todo.id === todoEditing ? (
                  <input
              ...
              <div>
                <button
                  className='bg-blue-500 rounded-full px-4 hover:bg-green-500'
                  onClick={() => {
                    doneTodo(todo.id)
                  }}
                >
                ...
                {todo.id === todoEditing ? (
                  <button
                    className='bg-blue-500 rounded-full px-4 hover:bg-yellow-300'
                ...
                <button
                  className='bg-blue-500 rounded-full px-4 hover:bg-red-400'
